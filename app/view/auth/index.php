...
<html lang="en">
    ...
    <head>
        ...
        <title>Login Pengguna - Arsip Surat -</title>
            ...
            <div class="d-flex justify-content-center align-items-center flex-wrap mt-1 pt-1">
                <div class="card shadow mb-4">
                    <div class="card-header py-2">
                        <h4 class="card-title text-center">- Login Pengguna - Arsip Surat -</h4>
                    </div>
                        ...
                        <form action="?aksi=signin" enctype="multipart/form-data" method="post">
                            ...
                            <div class="card-footer m-1">
                                <div class="text-center">
                                    ...
                                    <a href="../auth/register.php" aria-current="page" role="button"

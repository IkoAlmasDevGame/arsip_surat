        ...
        <div class="panel panel-body container bg-body-tertiary">
            <div class="panel-heading">
                ...
                <div class="breadcrumb d-flex justify-content-end align-items-end flex-wrap">
                    ...
                    <li class="breadcrumb breadcrumb-item">
                        <a href="?aksi=ubah-profile&id=<?php echo $_SESSION['id']?>" aria-current="page"
        ...
        <div class="card container">
            ...
            <div class="card-body mt-4">
                <div class="container">
                    ...
                    <?php 
                        $id = $_SESSION['id'];
                        $data = $konfigs->query("SELECT * FROM pengguna WHERE id_pengguna = '$id' and role = '$_SESSION[role]'");
                        while($isi = mysqli_fetch_array($data)){
                    ?>
                    <form action="?aksi=ubah-pengguna" enctype="multipart/form-data" method="post">
                                ...
                                <div class="card-body mt-1 bg-secondary">
                                    ...
                                    <div class="form-group mt-1 mt-lg-1">
                                        <div class="form-inline row justify-content-center
                                            ...
                                            <div class="form-label col-sm-4 col-md-4">
                                                <label for="" class="label label-default fs-4
                                                 display-5 text-light">Nama Pengguna</label>
                                            </div>
                                            <div class="col-sm-6 col-md-7">

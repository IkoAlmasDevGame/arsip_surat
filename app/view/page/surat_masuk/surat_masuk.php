        ...
        <div class="card container mb-3">
            <div class="card-header py-3">
                <h4 class="card-title fs-5 display-4 fst-normal text-dark fw-medium">
                    Surat Masuk - <?php echo $_SESSION['nama'] ?> -
                </h4>
            </div>
                        ...
                        <div class="d-table">
                            <table class="table-layout" id="example1">
                                ...
                                <tbody>
                                    <?php 
                                        $no = 1;
                                        $sql = "SELECT * FROM surat_masuk WHERE penerima = '$_SESSION[nama]' and jenis_surat='masuk'";
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-layout-2 text-center">
                                            ...
                                            <form action="?aksi=open-surat" method="post">
                                                <input type="hidden" name="id" value="<?php echo $isi['id']?>">
                                                <input type="hidden" name="status" value="sudah_dibaca">
                                                <button type="button" onclick="this.form.submit()"
                                                    ...
                                                    <i class="fa fa-file fa-1x text-light"></i>
                                                </button>
                                            </form>
                                            <?php }else{ ?>
                                        ...
                                        <td class="table-layout-2 text-center">
                                            ...
                                            <form action="?aksi=arsip-masuk" method="post">

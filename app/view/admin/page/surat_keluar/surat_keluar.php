        ...
        <div class="card container mb-4">
            <div class="card-header py-2">
                <h4 class="card-title fw-semibold text-black-50 fs-4 text-start">
                    <i class="fa fa-envelope-open fa-1x shadow shadow-sm text-danger"></i> Surat Keluar
                </h4>
            </div>
                            ...
                            <table class="table-layout" id="example1">
                                <thead class="table-head-fixed">
                                    <tr>
                                        ...
                                        <th class="table-layout-2 text-center">Tanggal</th>
                                ...
                                <tbody>
                                    <?php 
                                        $no = 1;
                                        $sql = "SELECT * FROM surat_keluar order by id asc";
